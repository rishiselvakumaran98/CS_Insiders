  ...
  async.waterfall([
    ...
    function(token, user, done) {
      var smtpTransport = nodemailer.createTransport({
        service: 'Gmail',
        auth: {
            user: 'rishi.selva15399@gmail.com',
            pass: 'ycvc bxkp vtuk rddb'
          
        }
      });
      var mailOptions = {
        to: user.username,
        from: 'CS_Insiders <noreply.CS_Insiders@gmail.com>',
        replyTo: 'noreply.CS_Insiders@gmail.com',
        subject: 'Password Reset',
        text: 'You are receiving this because you have requested the reset of the password for your account in CS Insiders.\n\n' +
...
router.post('/reset/:token', function(req, res) {
  async.waterfall([
    ...
    function(user, done) {
      ...
      var mailOptions = {
        to: user.username,
        from: 'passwordreset@CSInsiders.com <noreply.CS_Insiders@gmail.com>',
        replyTo: 'noreply.CS_Insiders@gmail.com',
        subject: 'Your password has been changed',
        text: 'Hello,\n\n' +
          'This is a confirmation that the password for your account ' + user.username + ' has been changed.\n Thank you for being a member of CS_Insiders!'
      };
      smtpTransport.sendMail(mailOptions, function(err) {
